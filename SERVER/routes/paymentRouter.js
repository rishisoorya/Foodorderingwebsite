...
import { createPayment,verifyPayment,getPayments } from '../controllers/paymentController.js';


const router=express.Router()
router.post("/create/:orderId", userMiddleware,createPayment );
router.post("/verify", userMiddleware, verifyPayment);
router.get("/transaction", userMiddleware,roleMiddleware("admin"), getPayments);
