      ...
      <div className="bg-white rounded-3xl shadow-2xl flex max-w-4xl overflow-hidden transition-all duration-500 hover:shadow-xl">
        <div className="w-full md:w-1/2 p-8 md:p-12">
          <div className="text-center mb-8">
            <h2 className="font-bold text-4xl text-pink-600 mb-2">
              Welcome Back
            </h2>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-between items-center">
              ...
              <a
                href="#"
                className="text-sm text-pink-600 hover:text-pink-800 transition-colors duration-300"
              >
                Forgot password?
              </a>
            </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-600">
            ...
            <a
              href="#"
              className="font-semibold text-pink-600 hover:text-pink-800 transition-colors duration-300"
            >
              Sign up
            </a>
          </div>
