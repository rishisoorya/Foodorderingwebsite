...
export default function UserProfilePage() {
  ...
  const calculateDiscount = (order) => {
    if (!order?.coupon || !order?.totalAmount || !order?.finalPrice)
      return "0.00";
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {address ? (
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden mb-8 p-6 text-center">
            ...
            {orders.length > 0 ? (
              <div className="space-y-6">
                {orders.map((order) => (
                  <div
                    key={
                      order._id || Math.random().toString(36).substring(2, 9)
                    }
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      ...
                      {order.coupon && (
                        <div className="flex justify-between mb-2 text-green-600">
                          <span>
                            Discount ({order.coupon.discountPercentage || 0}%):
                          </span>
