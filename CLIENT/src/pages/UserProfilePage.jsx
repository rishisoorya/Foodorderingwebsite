...
export default function UserProfilePage() {
  ...
  const [addressData, isAddressLoading, addressError] = UseFetch(
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">My Account</h1>
            ...
            <div className="px-6 py-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1">
                  ...
                  <p className="text-lg font-medium text-gray-900">{address.name || "N/A"}</p>
                </div>
                <div className="space-y-1">
                  <label className="block text-sm font-medium text-gray-500">Contact Phone</label>
                  <p className="text-lg font-medium text-gray-900">{address.phone || "N/A"}</p>
                </div>
                <div className="md:col-span-2 space-y-1">
                  <label className="block text-sm font-medium text-gray-500">Address</label>
                  <p className="text-lg font-medium text-gray-900">
                    {[address.houseName, address.streetName].filter(Boolean).join(", ") || "N/A"}
                  </p>
                  <p className="text-lg font-medium text-gray-900">
                    {[address.landmark, address.city].filter(Boolean).join(", ") || "N/A"}
                  </p>
                  <p className="text-lg font-medium text-gray-900">
