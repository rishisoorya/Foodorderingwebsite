    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-pink-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {/* Right Column - Promo Code and Checkout */}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-center space-x-4 pt-4 border-t border-pink-100">
                  ...
                  >
                    ...
                    ></path>
                    <path
                      d="M13 12c0-2.2-1.8-4-4-4s-4 1.8-4 4 1.8 4 4 4 4-1.8 4-4z"
                      fill="#EB001B"
                    ></path>
                    <path
                      d="M25 12c0-2.2-1.8-4-4-4s-4 1.8-4 4 1.8 4 4 4 4-1.8 4-4z"
                      fill="#FF5F00"
                    ></path>
                    <path
                      d="M21 12c0 2.2-1.8 4-4 4-1.1 0-2.1-.5-2.7-1.3 1.3-.9 2.2-2.4 2.2-4.1 0-1.7-.9-3.2-2.2-4.1.6-.8 1.6-1.3 2.7-1.3 2.2 0 4 1.8 4 4z"
                      fill="#F79E1B"
                    ></path>
                  </svg>
                  <svg className="h-6 w-auto" viewBox="0 0 38 24" fill="none">
                    ...
                    ></path>
                    <path
                      d="M11 17H9.4v-6.2H11v6.2zm-1-7c-.4 0-.7-.3-.7-.7 0-.4.3-.7.7-.7s.7.3.7.7c0 .4-.3.7-.7.7zm7 7h-1.6v-3.3c0-.8 0-1.4-.4-1.7-.4-.4-1-.4-1.6-.4-.5 0-1 .1-1.4.3V10h1.6v2.2c.3-.1.6-.2.9-.2.3 0 .5.1.6.2.1.2.2.5.2 1.1V17h-1.6v-3.4c0-.4 0-.7-.1-.9 0-.2-.2-.3-.3-.3-.2 0-.4.1-.5.3-.1.2-.2.5-.2.9V17H7v-6.2h1.6v.9c.5-.7 1.2-1 2.1-1 .7 0 1.3.2 1.7.6.4.4.6 1 .6 1.7V17zm5-3.3c0 1.3-.4 2.3-1.2 3-.8.7-1.8 1-3 1h-3.2V7h3c1.2 0 2.2.3 3 1 .8.7 1.2 1.7 1.2 3v.7zm-1.6-.7c0-1-.2-1.7-.7-2.2-.5-.5-1.2-.7-2.1-.7h-1.4v6.2h1.4c.9 0 1.6-.2 2.1-.7.5-.5.7-1.2.7-2.2v-.4zm9.2.7c0 1.3-.4 2.3-1.2 3-.8.7-1.8 1-3 1h-3.2V7h3c1.2 0 2.2.3 3 1 .8.7 1.2 1.7 1.2 3v.7zm-1.6-.7c0-1-.2-1.7-.7-2.2-.5-.5-1.2-.7-2.1-.7h-1.4v6.2h1.4c.9 0 1.6-.2 2.1-.7.5-.5.7-1.2.7-2.2v-.4z"
                      fill="#222"
                    ></path>
                  </svg>
                </div>
