        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium ${openFilter === 'all' ? 'bg-pink-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              All
            </button>
            <button
              onClick={() => setOpenFilter('open')}
              className={`px-4 py-2 rounded-full text-sm font-medium ${openFilter === 'open' ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Open Now
            </button>
            <button
              onClick={() => setOpenFilter('closed')}
              className={`px-4 py-2 rounded-full text-sm font-medium ${openFilter === 'closed' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Closed
            </button>
          </div>
